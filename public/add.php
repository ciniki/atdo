...
function ciniki_atdo_add(&$ciniki) {
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'appointment_date'=>array('required'=>'no', 'blank'=>'yes', 'default'=>'', 'type'=>'datetime', 'name'=>'Appointment Date'), 
        ...
        'due_date'=>array('required'=>'no', 'blank'=>'yes', 'type'=>'datetime', 'default'=>'', 'name'=>'Due Date'), 
